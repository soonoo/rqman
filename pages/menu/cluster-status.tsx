...
const ClusterStatusPage = () => {
  ...
  const responses = useQueries({
    queries: [
      { queryKey: ["status"], queryFn: rqlite.status },
      { queryKey: ["nodes"], queryFn: rqlite.nodes },
      { queryKey: ["expvar"], queryFn: rqlite.expvar },
      // TODO: add readiness status to somwhere else
